...
CXXFLAGS  := -std=c++11 -g2 -ggdb -fPIC -Wall -Werror -D_FILE_OFFSET_BITS=64 \
             -D_GNU_SOURCE -D BUILD_HASH=$(BUILD_HASH) -D COMMIT_COUNT=$(COMMIT_COUNT) \
             -I$(RELPATH) -I/opt/local/include -I/usr/local/include -I/usr/include/libxml2
