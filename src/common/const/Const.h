...
const std::string SERVER_LOCK_FILE = LTFSDM_TMP_DIR + DELIM + SERVER_COMMAND
        + std::string(".lock");
const std::string TRACE_FILE = LTFSDM_TMP_DIR + DELIM
        + std::string("OpenLTFS.trc");
const std::string LOG_FILE = LTFSDM_TMP_DIR + DELIM
        + std::string("OpenLTFS.log");
const std::string SOCKET_FILE = LTFSDM_TMP_DIR + DELIM
        + std::string("OpenLTFS.soc");
const std::string KEY_FILE = LTFSDM_TMP_DIR + DELIM
        + std::string("OpenLTFS.key");
...
const std::string DMAPI_TERMINATION_MESSAGE = std::string(
        "termination message");
const std::string FAILED_TAPE_ID = std::string("FAILED");
const std::string OPEN_LTFS_EA = std::string(".openltfs.");
const std::string OPEN_LTFS_EA_MANAGED = std::string(
        "trusted.openltfs.ismanaged");
const std::string OPEN_LTFS_EA_MOUNTPT = std::string(
        "trusted.openltfs.mountpt");
const std::string OPEN_LTFS_EA_FSNAME = std::string("trusted.openltfs.fsname");
const std::string OPEN_LTFS_EA_MIGINFO_INT = std::string(
        "trusted.openltfs.miginfo.int");
const std::string OPEN_LTFS_EA_MIGINFO_EXT = std::string(
        "trusted.openltfs.miginfo.ext");
